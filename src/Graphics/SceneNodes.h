...
class SkinnedMeshNode : public ShaderMeshNode
{
public:
    SkinnedMeshNode(int actorId, const std::string& name, const DirectX::XMMATRIX& worldMatrix)
        : ShaderMeshNode(actorId, name, worldMatrix)
    {
    }
