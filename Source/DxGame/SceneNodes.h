...
public:
	...
	{
		{ { 1,-1,-1}, {0.7f,0.5f,0.5f}, {1,0,0} },
		{ { 1, 1,-1}, {0.7f,0.5f,0.5f}, {1,0,0} },
		{ { 1, 1, 1}, {0.7f,0.5f,0.5f}, {1,0,0} },
		{ { 1,-1, 1}, {0.7f,0.5f,0.5f}, {1,0,0} },

		{ {-1,-1, 1}, {0.5f,0.7f,0.5f}, {-1,0,0} },
		{ {-1, 1, 1}, {0.5f,0.7f,0.5f}, {-1,0,0} },
		{ {-1, 1,-1}, {0.5f,0.7f,0.5f}, {-1,0,0} },
		{ {-1,-1,-1}, {0.5f,0.7f,0.5f}, {-1,0,0} },

		{ {-1, 1,-1}, {0.5f,0.5f,0.7f}, {0,1,0} },
		{ { 1, 1,-1}, {0.5f,0.5f,0.7f}, {0,1,0} },
		{ { 1, 1, 1}, {0.5f,0.5f,0.7f}, {0,1,0} },
		{ {-1, 1, 1}, {0.5f,0.5f,0.7f}, {0,1,0} },

		{ {-1,-1, 1}, {0.7f,0.7f,0.5f}, {0,-1,0} },
		{ { 1,-1, 1}, {0.7f,0.7f,0.5f}, {0,-1,0} },
		{ { 1,-1,-1}, {0.7f,0.7f,0.5f}, {0,-1,0} },
		{ {-1,-1,-1}, {0.7f,0.7f,0.5f}, {0,-1,0} },

		{ {-1,-1, 1}, {0.7f,0.5f,0.7f}, {0,0,1} },
		{ {-1, 1, 1}, {0.7f,0.5f,0.7f}, {0,0,1} },
		{ { 1, 1, 1}, {0.7f,0.5f,0.7f}, {0,0,1} },
		{ { 1,-1, 1}, {0.7f,0.5f,0.7f}, {0,0,1} },

		{ { 1,-1,-1}, {0.5f,0.7f,0.7f}, {0,0,-1} },
		{ { 1, 1,-1}, {0.5f,0.7f,0.7f}, {0,0,-1} },
		{ {-1, 1,-1}, {0.5f,0.7f,0.7f}, {0,0,-1} },
		{ {-1,-1,-1}, {0.5f,0.7f,0.7f}, {0,0,-1} }
	};
