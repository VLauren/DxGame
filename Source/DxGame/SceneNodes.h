...
public:
	...
	static constexpr VertexPositionColor cubeVerts[24] =
	{
		{ { 1,-1,-1}, {0.7f,0.5f,0.5f} }, { { 1, 1,-1}, {0.7f,0.5f,0.5f} },
		{ { 1, 1, 1}, {0.7f,0.5f,0.5f} }, { { 1,-1, 1}, {0.7f,0.5f,0.5f} },

		{ {-1,-1, 1}, {0.5f,0.7f,0.5f} }, { {-1, 1, 1}, {0.5f,0.7f,0.5f} },
		{ {-1, 1,-1}, {0.5f,0.7f,0.5f} }, { {-1,-1,-1}, {0.5f,0.7f,0.5f} },

		{ {-1, 1,-1}, {0.5f,0.5f,0.7f} }, { { 1, 1,-1}, {0.5f,0.5f,0.7f} },
		{ { 1, 1, 1}, {0.5f,0.5f,0.7f} }, { {-1, 1, 1}, {0.5f,0.5f,0.7f} },

		{ {-1,-1, 1}, {0.7f,0.7f,0.5f} }, { { 1,-1, 1}, {0.7f,0.7f,0.5f} },
		{ { 1,-1,-1}, {0.7f,0.7f,0.5f} }, { {-1,-1,-1}, {0.7f,0.7f,0.5f} },

		{ {-1,-1, 1}, {0.7f,0.5f,0.7f} }, { {-1, 1, 1}, {0.7f,0.5f,0.7f} },
		{ { 1, 1, 1}, {0.7f,0.5f,0.7f} }, { { 1,-1, 1}, {0.7f,0.5f,0.7f} },

		{ { 1,-1,-1}, {0.5f,0.7f,0.7f} }, { { 1, 1,-1}, {0.5f,0.7f,0.7f} },
		{ {-1, 1,-1}, {0.5f,0.7f,0.7f} }, { {-1,-1,-1}, {0.5f,0.7f,0.7f} }
	};
